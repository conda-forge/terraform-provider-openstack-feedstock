...
validate_recipe_outputs "terraform-provider-openstack-feedstock"

if [[ "${UPLOAD_PACKAGES}" != "False" ]]; then
  echo -e "\n\nUploading the packages."
  upload_package --validate --feedstock-name="terraform-provider-openstack-feedstock" ./ ./recipe ./.ci_support/${CONFIG}.yaml
fi